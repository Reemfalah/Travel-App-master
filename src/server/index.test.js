...
describe("GET endpoints", () => {
    it("should get the weather forecast", async () => {
        const res = await request(app).get("/darkSky?latitude=-33.923189097929544&longitude=150.9193301849991&time=1577232000");
    ...
    it("should get an error because there are no images of this type", async () => {
        const res = await request(app).get("/pixabay?image=asdfasdfsd");
